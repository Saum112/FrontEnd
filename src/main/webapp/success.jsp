...
<body>
		<header style="background-color:#87CEFA; color:#0000A0;">			
							...
							<span style="font-size:25px; color:#0000CD; font-weight:Arial;position:absolute; right:90px;">
							Welcome <c:out value = "${hrmId}"/></span>
    ...
    <legend class="scheduler-border">Employee Listings</legend>		
  			...
  			<table class = "table table-striped table-bordered table-hover">
  				<tr>
  					<th bgcolor="#1E90FF"><font color="#fff">Employee Code</font></th>
  					<th bgcolor="#1E90FF"><font color="#fff">Employee Name</font></th>
  					<th bgcolor="#1E90FF"><font color="#fff">Location</font></th>
  					<th bgcolor="#1E90FF"><font color="#fff">E-mail</font></th>
  					<th bgcolor="#1E90FF"><font color="#fff">Date Of Birth</font></th>
  					<th bgcolor="#1E90FF"><font color="#fff">Actions</font></th>
  				</tr>
				...
				<tr class = "emp_row">
					...
					<td>
						<form action = "edit.jsp" method = "get">
							...
							<input type = "submit" value = "Edit" class="btn btn-secondary"  style="font-size: 18px; width: 100px; background-color:#87CEFA;" >
						</form>
